...
const Robot = ({ robot, setRobot, robotImage, setRobotImage, studioId, oldRobotImage, setOldRobotImage, sectionName }) => {
  ...
  <div className="mt-4">
    ...
    <img
      src={robotImage instanceof File ? URL.createObjectURL(robotImage) : robotImage}
      alt="Preview"
          ...
          <button
            ...
            onClick={async () => {
              try {
                ...
                setOldRobotImage((prev) => prev.filter((u) => u !== url));
          ...
          <div className="mt-8">
            ...
            <div className="mb-4 mt-4">
              ...
              <p className="text-sm text-gray-500 mt-1">
                {robot.description?.trim() === ""
                  ? 0
                  : robot.description?.trim().split(/\s+/).length || 0}
                /60 words
              </p>
            </div>
            <div className="mb-4 mt-4">
              ...
              />
              <p className="text-sm text-gray-500 mt-1">
                {robot.description2?.trim() === ""
                  ? 0
                  : robot.description2?.trim().split(/\s+/).length || 0}
                /60 words
              </p>
            </div>
            <div className="mb-4">
