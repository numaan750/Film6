...
const Competate3 = ({ competate3, setCompetate3, competateImage3, setCompetateImage3, studioId, oldCompetateImage3, setOldCompetateImage3, sectionName }) => {
  ...
  <div className="mt-4">
    ...
    <img
      src={competateImage3 instanceof File ? URL.createObjectURL(competateImage3) : competateImage3}
      alt="Preview"
      className="w-36 h-auto"
    />
  </div>
)}
{oldCompetateImage3 && oldCompetateImage3.length > 0 && (
  <div className="mt-4">
    <h2 className="text-sm font-semibold text-gray-500 mb-1">OLD IMAGES</h2>
    <div className="flex gap-2 flex-wrap">
      {[...oldCompetateImage3].reverse().map((url, index) => (
