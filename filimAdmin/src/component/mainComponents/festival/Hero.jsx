...
const Hero = () => {
  ...
  return (
    <div className=''>
      ...
      <FestivalCards cards={cards} setCards={setCards} mainTitle={mainTitle} setMainTitle={setMainTitle} showCardPopup={showCardPopup} setShowCardPopup={setShowCardPopup} popupIndex={popupIndex} setPopupIndex={setPopupIndex} tempCard={tempCard} setTempCard={setTempCard} openCardPopup={openCardPopup} saveCard={saveCard} />
      <Runway
        runway={runway}
        setRunway={setRunway}
